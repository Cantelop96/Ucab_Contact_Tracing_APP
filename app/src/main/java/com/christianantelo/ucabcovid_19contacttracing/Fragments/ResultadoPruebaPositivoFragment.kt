 ...
 * Use the [ResultadoPruebaPositivoFragment.newInstance] factory method to
...
class ResultadoPruebaPositivoFragment : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment ResultadoPruebaPositivoFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            ResultadoPruebaPositivoFragment().apply {
